...
# PD controllers for theta and r
kP_theta = 1
kD_theta = 3
kD_r= 6
kP_r= 6

#arrays for storing the updating values of control objectives
r_arr = []              
r_d_arr = []            
theta_arr= []           
theta_d_arr = [] 
...
# resolving the components in 2d plane
...
#   Euler's approach for solving dynamics
...
def anime():
    ...
    # ani.save('2D Min Accel.mp4',writer='ffmpeg',fps=30,bitrate=1800)     # to save the clip
